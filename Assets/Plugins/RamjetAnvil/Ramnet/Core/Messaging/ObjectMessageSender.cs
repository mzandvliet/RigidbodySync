...
namespace RamjetAnvil.RamNet {
    ...
    public enum ObjectRole : byte {
        ...
        /// If the owner and authority are the same instance the message will only be sent once.
        /// </summary>
        Authority = 1,
        /// <summary>
    ...
    public interface IObjectMessageSender {
        void Send<T>(NetworkMessage<T> message, ObjectRole recipient) where T : IObjectMessage;
    }
}
